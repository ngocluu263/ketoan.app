...
{
    public partial class INTHUEDR : Form
    {
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            if (rdMau1.Checked)
                Utlity.WriteDataTableToExcel_THUEDR_Mau1(dt, dtpTuNgay.Value, dtpDenngay.Value, dtNgayin.Value);
            if (rdMau2.Checked)
                Utlity.WriteDataTableToExcel_THUEDR_Mau2(dt, dtpTuNgay.Value, dtpDenngay.Value, dtNgayin.Value);
            if (rdMau3.Checked)
                Utlity.WriteDataTableToExcel_THUEDR_Mau1(dt, dtpTuNgay.Value, dtpDenngay.Value, dtNgayin.Value);
        }
        #endregion
