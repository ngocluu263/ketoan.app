...
{
    public partial class InCanDoiPhatSinhTaiKhoan : Form
    {
        ...
        public InCanDoiPhatSinhTaiKhoan()
        {
            InitializeComponent();
        }
        ...
        private void LoadTK()
        {
            ...
            cboSokytu.DisplayMember = "MA_TK";
            cboSokytu.ValueMember = "ID";
            cboSokytu.DropDownColumns = "MA_TK,TEN_TK";
            cboSokytu.DataSource = _KTTKRepo.GetAll();
            cboSokytu.SelectedIndex = -1;
        }
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            var list = this._db.KT_CTuGocs.Where(u => u.NGAY_CTU.Value != null && u.NGAY_CTU.Value.Date >= dtpTuNgay.Value.Date && u.NGAY_CTU.Value.Date <= dtpDenngay.Value.Date
                && (u.TK_NO == cboSokytu.Text || cboSokytu.Text == ""));
            ...
            if (rdExcelMauchuan.Checked)
                Utlity.WriteDataTableToExcel_InCanDoiPhatSinhTaiKhoan_Mau1(dt, cboSokytu.Text, dtpTuNgay.Value, dtpDenngay.Value, dtNgayin.Value);
            else
                Utlity.WriteDataTableToExcel_InCanDoiPhatSinhTaiKhoan_Mau1(dt, cboSokytu.Text, dtpTuNgay.Value, dtpDenngay.Value, dtNgayin.Value);
        }
        #endregion
