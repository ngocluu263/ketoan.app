...
{
    public partial class SOCTCN21 : Form
    {
        ...
        private void SOCTCN21_Load(object sender, EventArgs e)
        {
            loaddtpNgay();
            LoadTK();
            LoadDT();
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            if (rdMau1.Checked)
                Utlity.WriteDataTableToExcel_SOCTCN21_331_01_V_Mau1(dt, cboTaikhoan.Text, cboMaDT.Text, dtpTuNgay.Value, dtpDenngay.Value, dtNgayin.Value);
            else
                Utlity.WriteDataTableToExcel_SOCTCN21_331_01_V_Mau1(dt, cboTaikhoan.Text, cboMaDT.Text, dtpTuNgay.Value, dtpDenngay.Value, dtNgayin.Value);
        }
        #endregion
